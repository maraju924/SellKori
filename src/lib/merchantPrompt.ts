...
export const MERCHANT_STYLE_OVERRIDE_HINT = [
  ...
  'ব্যবসায়িক নিরাপত্তা ভাঙবে না: minPrice-এর নিচে দাম নয়, স্টক/দাম/পলিসি বানিয়ে বলা নয়, ফোন-ঠিকানা ছাড়া অর্ডার কনফার্ম নয়, নিজেকে এআই/বট বলে স্বীকার নয়।',
].join('\n');
...
export function buildMerchantCustomInstructionBlock(raw: unknown): string {
  ...
  return [
    ...
    'এগুলো ব্যবসায়িক নিরাপত্তা নিয়ম (minPrice, স্টক/দাম বানিয়ে না বলা, অর্ডারের ফোন-ঠিকানা যাচাই, নিজেকে এআই বলে স্বীকার না করা) ভাঙতে পারবে না।',
    '',
    custom,
  ].join('\n');
}
